...
const express = require("express"),
  ...
  { ConnectMySql } = require("./database/mysql.database"),
  { ConnectMongoDB } = require("./database/mongodb.database"),
...
app.use((request, response, next) => {
  if (request.session.userInfo === undefined) request.session.userInfo = {};
...
|--------------------------------------------------------------------------
*/
app.use("/api/version", methodMiddleware(['GET']), appRouter);
